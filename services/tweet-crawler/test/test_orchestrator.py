...
def test_crawl_all():
    ...
    mock_tweet_crawler.get.assert_called_once_with('Test politician 2', min_tweet_id='20')
...
def test_crawl_all_no_job():
    ...
    mock_tweet_crawler.get.assert_called_once_with('Test politician 2', min_tweet_id='1')
    mock_tweet_repository.insert.assert_called_once()