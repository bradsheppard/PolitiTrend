...
const HomeElectionMatchup: React.FC<IProps> = (props: IProps) => {
    const sentimentDifference =
        props.challenger.sentiment * 5 + 5 - (props.incumbent.sentiment * 5 + 5)
            ...
            <Grid container>
                <Grid item xs={12} sm={6} className={classes.item}>
                    <div className={classes.imageContainer}>
                        <img
                            src={politicianNameToImagePath(props.incumbent.name)}
                            alt={props.incumbent.name}
                ...
                <Grid item xs={12} sm={6} className={classes.item}>
                    <div className={classes.imageContainer}>
                        <img
                            src={politicianNameToImagePath(props.challenger.name)}
                            alt={props.challenger.name}
                            className={classes.image}
                        />
                    </div>
                    <div>
