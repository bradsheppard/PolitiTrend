...
describe('GlobalWordCloudController (e2e)', () => {
    it('/global-word-cloud (GET)', async () => {
        ...
        const response = await request(app.getHttpServer()).get('/global-word-cloud');
    ...
    it('/global-word-cloud?limit=1 (GET)', async () => {
        ...
        const response = await request(app.getHttpServer()).get(`/global-word-cloud?limit=1`);
    ...
    it('/global-word-cloud?limit=1&offset=1 (GET)', async () => {
        ...
        const response = await request(app.getHttpServer()).get(
            '/global-word-cloud?limit=1&offset=1',
        );
    ...
    it('handle word cloud created', async () => {
        ...
        const json = await client
            .emit('analytics-global-word-cloud-created', createWordCloudDto)
            .toPromise();
