...
describe('Sentiment (e2e)', () => {
    it('/sentiment (GET)', async () => {
        ...
        const response = await request(app.getHttpServer()).get('/sentiment');
    ...
    it('/sentiment?politician={id} (GET) One day', async () => {
        ...
        const response = await request(app.getHttpServer()).get('/sentiment?politician=1');
    ...
    it('/sentiment?politician={id}&resample=86400000 (GET) One day with resampling', async () => {
        ...
        const response = await request(app.getHttpServer()).get(
            '/sentiment?politician=1&resample=86400000',
        );
    ...
    it('/sentiment?politician={id}&start=2020-01-01&resample=86400000 (GET) Multiple day downsampling', async () => {
        ...
        const response = await request(app.getHttpServer()).get(
            '/sentiment?politician=1&start=2020-01-01&resample=86400000',
        );
    ...
    it('/sentiment?minSampleSize=3 (GET)', async () => {
        ...
        const response = await request(app.getHttpServer()).get('/sentiment?minSampleSize=3');
