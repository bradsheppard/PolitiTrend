...
def test_get_entity_sentiments_repeated_party(politicians):
    ...
    positive_score = get_entity_sentiments(positive_sentence, politicians)
    negative_score = get_entity_sentiments(negative_sentence, politicians)
    mean_score = get_entity_sentiments(mean_sentence, politicians)
